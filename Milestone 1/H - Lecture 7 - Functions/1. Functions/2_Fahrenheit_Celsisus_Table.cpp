/*
        Question  : Fahrenheit Celsisus Table
        ...
        Problem statement
                ...
                been taken care of and you need to just print the integer value .
                Just write the code that prints Fahrenheit to Celsius table in the
                function itself.
                ...
                and Celsius Fahrenheit value. Fahrenheit value and its corresponding
                ...
                Start value is 120, end value is 200 and step size is 40. Therefore, the
                values we need to convert are 120, 120 + 40 = 160, and 160 + 40 = 200.
                ...
                But we'll only print 48 because we are only interested in the integral
                part of the value.
