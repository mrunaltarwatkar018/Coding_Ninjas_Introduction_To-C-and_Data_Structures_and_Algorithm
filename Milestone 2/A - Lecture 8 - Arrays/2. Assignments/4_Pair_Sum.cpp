/*
        ...
        Problem statement
            ...
            Find and return the total number of pairs in the array/list
            which sum to X.
            ...
            Output format :
            For each test case, print the total number of pairs present in
            the array/list.
            ...
            Since there doesn't exist any pair with sum equal to 12 for the first
            query, we print 0.

            For the second query, we have 2 pairs in total that sum up to 10. They
            are, (2, 8) and (5, 5).
*/
