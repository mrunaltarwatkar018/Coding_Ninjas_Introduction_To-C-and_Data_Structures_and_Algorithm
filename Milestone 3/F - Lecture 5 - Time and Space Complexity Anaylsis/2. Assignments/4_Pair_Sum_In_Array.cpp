...
/* 
    Question  : Pair Sum In Array
                ...
                Input format : 
                                ...
                                integer 'N' representing the size of the first array/list.
                ...
                Output Format : 
                                For each test case, print the total number of pairs 
                ...
                Explanation for Input 2 :
                                        Since there doesn't exist any pair with sum equal to 
                                        12 for the first query, we print 0.
                                        For the second query, we have 2 pairs in total that 
                                        sum up to 10. They are, (2, 8) and (5, 5).             
*/
