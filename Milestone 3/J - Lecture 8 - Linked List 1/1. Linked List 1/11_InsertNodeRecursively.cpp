/* =================================================================================================================== */
/* 
    Question  : Insert node (recursive)
                You have been given a linked list of integers. Your task is to 
                write a function that inserts a node at a given position, 'pos'.
                ...
                Input format : 
                                ...
                                The second line of each test case contains two space 
                                separated integers, that denote the value of 'pos' and 
                                the data to be inserted respectively.  
                ...
                Sample Output 1 : 3 4 5 100 2 6 1 9

                Sample Input 2 : 1     
                                 3 4 5 2 6 1 9 -1
                                 0 20      
                                          
                Sample Output 2 : 20 3 4 5 2 6 1 9
...
int main() {
    ...
    while (t--) {
        ...
        Node *head = takeinput();
        cout << "Enter the position and requierd data of the Linked List : ";
        int pos, data;
        cin >> pos >> data;
