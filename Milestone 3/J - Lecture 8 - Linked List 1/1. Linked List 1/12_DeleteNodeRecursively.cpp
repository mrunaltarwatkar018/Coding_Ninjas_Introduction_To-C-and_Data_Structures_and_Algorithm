/* =================================================================================================================== */
/* 
    Question  : Delete node (recursive)
                Given a singly linked list of integers and position 'i', delete 
                the node present at the 'i-th' position in the linked list 
                recursively.
                ...
                Input format : 
                                ...
                                The second line of input contains a single integer depicting 
                                the value of 'i'.  
...
int main() {
    ...
    while (t--) {
        ...
        Node *head = takeinput();
        int pos;
        cout << "Enter the position of the Linked List i  which delete the ith Node : ";
        cin >> pos;
