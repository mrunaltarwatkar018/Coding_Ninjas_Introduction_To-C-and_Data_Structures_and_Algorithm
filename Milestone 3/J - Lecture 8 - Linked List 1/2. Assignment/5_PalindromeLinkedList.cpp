...
/* 
    Question  : Palindrome Linked List
                ...
                Input format : 
                               ...
                               contains the the elements of the singly linked list 
                ...
                Output Format : 
                                For each test case, the only line of output that print 'true' 
                                if the list is Palindrome or 'false' otherwise.
                ...
                Explanation for sample Output 2 :   
                                                    For the first query, it is pretty intuitive that the the 
                                                    given list is not a palindrome, hence the output is 'false'.

                                                    For the second query, the list is empty. An empty list is 
                                                    always a palindrome , hence the output is 'true'.
