...
// 1 2 3 4 5 6 9 7 8
// Pre-order traversal printing the tree (i.e. when the root says, first print me and then after my children number likewise ): 1 2 5 6 7 8 3 4 9
...
/*
    ...
    right subtree and visit in a similar manner.
*/
